...
```bash
git clone https://github.com/Blockvopersist/ASCII-Aquarium-224.git
cd ASCII-Aquarium-224
...
food when you tap the glass.
    ...
    <td width="55%" valign="top">
      <img
        src="https://github.com/Blockvopersist/ASCII-Aquarium-224/34200303-25c9-45c5-a6eb-1e53a6c267d7"
...
<table>
  <tr>
    ...
    <img
        src="https://github.com/Blockvopersist/ASCII-Aquarium-224/b350f4ad-5aa9-4560-84a4-927dffa96d35"
        alt="Settings"
        width="100%">
    </td>
    <td width="50%" valign="top">
      <img
        src="https://github.com/Blockvopersist/ASCII-Aquarium-224/12696457-80b7-4ba0-9382-38a2e72ea84d"
...
<p>• If the image looks faint, doubled, or not quite centred, rotate or flip the cube and try again. Beam splitters can be a bit fin-icky about orientation.</p>
    ...
    <td width="50%" valign="top">
      <img
        src="https://github.com/Blockvopersist/ASCII-Aquarium-224/36b6a33d-72d2-48c5-ae38-65e8de0e304c"
